...
use App\Services\DownstreamResponse;
...
{
    public function test_construct_a_response_with_a_success()
    {
        $token = 'new_token';
        $fcmResBody = '{
            "multicast_id": 108,
        ...
        $response = new Response(200, [], $fcmResBody);
    ...
    public function test_construct_a_response_with_multiple_successes()
    {
        $tokens = [
            'first_token',
            'second_token',
    ...
    public function test_construct_a_response_with_a_failure()
    {
        $token = 'new_token';
        $fcmResBody = '{
            "multicast_id": 108,
    ...
    public function test_construct_a_response_with_multiple_failures()
    {
        $tokens = [
            'first_token',
            'second_token',
    ...
    public function test_construct_a_response_with_a_token_to_change()
    {
        $token = 'new_token';
        $fcmResBody = '{
            "multicast_id": 108,
    ...
    public function test_construct_a_response_with_multiple_tokens_to_change()
    {
        $tokens = [
            'first_token',
            'second_token',
    ...
    public function test_construct_a_response_with_a_token_unavailable()
    {
        $token = 'first_token';
        $fcmResBody = '{ 
            "multicast_id": 216,
    ...
    public function test_construct_a_response_with_a_token_server_error()
    {
        $token = 'first_token';
        $fcmResBody = '{ 
            "multicast_id": 216,
    ...
    public function test_construct_a_response_with_a_token_exceeded()
    {
        $token = 'first_token';
        $fcmResBody = '{ 
            "multicast_id": 216,
    ...
    public function test_construct_a_response_with_a_mixed_token_to_retry()
    {
        $tokens = [
            'first_token',
            'second_token',
    ...
    public function test_construct_a_response_with_mixed_response()
    {
        $tokens = [
            'first_token',
            'second_token',
    ...
    public function test_construct_a_response_with_multiples_response()
    {
        $tokens = [
            'first_token',
            'second_token',
